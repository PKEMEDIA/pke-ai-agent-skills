...
3. **Initialize**: `bash /root/.grok/skills/skill-creator/scripts/init-skill.sh <skill-name> /home/workdir/.grok/skills [--resources scripts,references,assets]`
...
6. **Validate**: `bash /root/.grok/skills/skill-creator/scripts/validate-skill.sh "<full-path>"` — fix FAIL immediately.
...
- Load `/home/workdir/.grok/skills/auto-file-naming/SKILL.md` when naming outputs.
